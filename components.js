  ...
  this.shadowRoot.innerHTML = `
    <style>
      ...
      .cat-container::before{
        ...
        pointer-events:none;
        background:
          radial-gradient(circle at 72% 30%, rgba(236,72,153,.42), transparent 34%),
          radial-gradient(circle at 28% 68%, rgba(56,189,248,.30), transparent 34%),
          linear-gradient(to top, rgba(15,23,42,.88), transparent 72%);
        filter:blur(3px);
        opacity:.9;
      }
